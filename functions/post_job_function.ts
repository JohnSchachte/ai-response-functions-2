  ...
  async ({ inputs, env, client }) => {
    ...
    try{
      ...
      */
      ...
      try{
        let msgResponse;
        const fallbackText = "AI Response POS Escalation";
        const cautionText = "Please proceed with caution: the following text was generated by an AI model trained on Zendesk articles";
        if(isDev){
