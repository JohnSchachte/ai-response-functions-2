...
export const postUserRatingToUser = DefineFunction({
  callback_id: "post_rating_to_user",
  title: "Posts User AI Feedback to Submitter",
  description: "Posts the user rating to the AI backend endpoints for storage in db",
  source_file: "functions/post_rating_to_user_function.ts",
  input_parameters: {
    properties: {
        aivUserId: {
        ...
        submitterId: {
          ...
          description: "User Id to Message AI response to",
        },
        endpointIndicator: {
          type: Schema.types.string,
    ...
    required: ["aivUserId","feedback","isPostSuccess","submitterId","endpointIndicator"],
  }
});

export default SlackFunction(
    postUserRatingToUser,
